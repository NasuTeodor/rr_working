...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    /**
     * replaced by setMotorPowers(leftFront, leftRear, rightFront, rightRear)
     */
    public void putere( double leftFrontPower, double rightFrontPower, double leftRearPower, double rightRearPower ){
    ...
    public void stop_motor(){ putere(0,0,0,0); }
